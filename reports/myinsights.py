...
file_path = 'reports/all_table_data.csv'
df = pd.read_csv(file_path)

# Ensure 'Margin' and 'Total Votes' columns are numeric
...
# 2. Vote Margin Analysis - Top 10 Closest Contests
closest_contests = df.nsmallest(10, 'Margin')

# Plotting Closest Contests
plt.figure(figsize=(10, 6))
...
# 3. Voter Turnout Analysis (Assuming 'Total Votes' can be used to approximate turnout)
turnout_by_state = df.groupby('Parliament Constituency')['Total Votes'].sum().reset_index()

# Plotting Voter Turnout Analysis
plt.figure(figsize=(10, 6))
...
# Insight 1: Representation by Party
...
# Insight 3: Smallest Vote Margin
...
# Insight 4: Total Votes by Party
...
# Insight 5: Average Margin by Party
...
# Insight 6: Top 10 Candidates by Votes
...
# Insight 7: Top 10 Candidates by Margin
...
# Insight 8: Bottom 10 Candidates by Margin
...
# Insight 9: Votes Distribution by Party
plt.figure(figsize=(10, 6))
...
# Insight 10: Margin Distribution by Party
plt.figure(figsize=(10, 6))
...
# Heatmap: Total Votes by Party and Parliament Constituency
